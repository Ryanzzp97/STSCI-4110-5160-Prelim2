---
title: "Data_Cleaning"
author: "Chang Chen, Lincy Chen, Lingyu Zhou, Ryan Zhou"
date: "11/14/2023"
output: pdf_document
---
...
\begin{align*}
\text{logit}(\pi_E)&=\ln  \left( \frac{\mathbb{P}(\text{event})}{1-\mathbb{P}(\text{event})} \right)\\&=\beta_0+ \beta_{\text{age}} \text{age}+ \beta_{\text{Ethnic:Other}} \text{Ethnic:Other} +\beta_{\text{Ethnic:White}} \text{Ethnic:White}\\&+\beta_{\text{Ethnic:White}} \text{Ethnic:White}+\beta_{\text{Smoker}} \text{Smoker} + \beta_{\text{BMI}} \text{BMI}
\end{align*}
